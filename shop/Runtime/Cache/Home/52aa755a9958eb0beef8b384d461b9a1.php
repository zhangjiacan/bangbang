...
<div class="block1">
  <div class="allMenu fl"> <a href="" title="" style="font-size:15px;" class="index current">首页</a> 
	...
	<div class="ur_here blank">
	 ...
	 <h1 style="background:url(./images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px;"><a href=""><font style="color:#000; font-size:14px;">所有分类</font></a></h1>
	...
	<h1 class="mod2tit" style="background:url(./images/sdgg.gif) repeat-x; height:27px; color:#000">历史浏览</h1>
   ...
   <?php if(is_array($his)): foreach($his as $key=>$h): ?><li>
			 <div class="first">
			  <div class="fl">
				<font style="color:#F00; font-weight:bold"><?php echo ($h['goods_id']); ?>。</font> <a href="" title=""><?php echo ($h['goods_name']); ?></a>
				</div>
			 ...
			 <div class="last">
			  <a href=""><img src="/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="" align="left"></a>
				<b class="f1"><?php echo ($h['goods_id']); ?>。</b> <a href="" title=""><b><?php echo ($h['goods_name']); ?></b></a><br>
				本店售价：<b class="f1">￥<?php echo ($h['shop_price']); ?>元</b><br> 
			 </div>
    ...
    <form name="compareForm" action="" method="post">
        <div class="clearfix grid"> 
          <?php if(is_array($cat_goods)): foreach($cat_goods as $key=>$cats): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
            <div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$cats['goods_id']));?>"><img src="<?php echo ($cats['goods_img']); ?>" alt=""></a></div>
            <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$cats['goods_id']));?>" title=""><?php echo ($cats['goods_name']); ?></a><br>
