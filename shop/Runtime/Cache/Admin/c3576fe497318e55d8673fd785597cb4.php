...
<table cellpadding="3" cellspacing="1">
  ...
  <?php if(is_array($goods)): foreach($goods as $key=>$g): ?><tr>
    ...
    <td align="center"><img src="/shop/Public/Admin/images/<?php echo ($g['is_on_sale']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/<?php echo ($g['is_best']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/<?php echo ($g['is_new']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/shop/Public/Admin/images/<?php echo ($g['is_hot']?'yes':'no'); ?>.gif"  /></td>
    ...
    <td align="center"><span >100</span></td>
      ...
      <a href="<?php echo U('Admin/Goods/del',array('goods_id'=>$g['goods_id']));?>"  title="回收站"><img src="/shop/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
