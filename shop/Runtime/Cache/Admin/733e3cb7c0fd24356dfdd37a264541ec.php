...
<?php if(is_array($list)): foreach($list as $key=>$ls): ?><tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style='padding-left="0"'>
            <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:<?php echo ($ls['lev']*2); ?>em" />
    ...
    <td width="24%" align="center">
      ...
      <a href="<?php echo U('Admin/Cat/del',array('cat_id'=>$ls['cat_id']));?>" title="移除">移除</a>
    </td>
