...
<div class="recommendContent entry-content" id="show_hot_area">
      <?php if(is_array($hots)): foreach($hots as $key=>$hots): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=13.htm"><img src=".<?php echo ($hots["goods_img"]); ?>" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
			 <a href="./goods.php-id=13.htm" title="<?php echo ($hots["goods_name"]); ?>"><?php echo ($hots["goods_name"]); ?></a><br>
              <font class="goodspice market">￥<?php echo ($hots["market_price"]); ?>元</font>
			 			 <b class="f1">￥<?php echo ($hots["shop_price"]); ?>元</b><br>
